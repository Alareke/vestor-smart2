...
export const FuturesAnalysis = ({ userAnalyses = [] }) => {
    ...
    const staticData = useMemo(() => [
        {
            id: 1,
            img: 'https://images.unsplash.com/photo-1588392382834-a891154bca4d?q=80&w=420&h=224&auto=format&fit=crop',
            title: t('fa_card1_title'),
            description: t('fa_card1_desc'),
            author: t('fa_card1_author'),
            date: t('fa_card1_date'),
            likes: 9,
        },
        {
            id: 2,
            img: 'https://images.unsplash.com/photo-1563336339-4b2c159f5b3a?q=80&w=420&h=224&auto=format&fit=crop',
            title: t('fa_card2_title'),
            description: t('fa_card2_desc'),
            author: t('fa_card2_author'),
            date: t('fa_card2_date'),
            likes: 8,
        },
        {
            id: 3,
            img: 'https://images.unsplash.com/photo-1518186225333-349475420958?q=80&w=420&h=224&auto=format&fit=crop',
            title: t('fa_card3_title'),
            description: t('fa_card3_desc'),
            author: t('fa_card3_author'),
            date: t('fa_card3_date'),
            likes: 9,
        },
        {
            id: 4,
            img: 'https://images.unsplash.com/photo-1589998059171-988d887df646?q=80&w=420&h=224&auto=format&fit=crop',
            title: t('fa_card2_title'), // Reusing for variety
            description: t('fa_card2_desc'),
            author: t('fa_card2_author'),
            date: t('fa_card2_date'),
            likes: 11,
    ...
    return (
        <section>
            <div className="flex flex-wrap justify-between items-center mb-4 gap-2">
                <div>
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">{t('futures_analysis_title1')} {language === 'ar' ? '<' : '>'}</h2>
                    <p className="text-gray-600 dark:text-gray-400">{t('futures_analysis_title2')}</p>
                </div>
            </div>
