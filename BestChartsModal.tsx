...
export const BestChartsModal = ({ isOpen, onClose }) => {
    const { t } = useLanguage();
    ...
    return createPortal(
        ...
        >
            ...
            >
                ...
                >
                    <h2 className="text-xl font-bold select-none">{t('products_best_charts_title')}</h2>
                ...
                <div className="flex-1 relative bg-white dark:bg-gray-900 dark:bg-black">
                    ...
                    <iframe
                        src="https://vestorsmart-chart-m.netlify.app/"
                        className="w-full h-full border-0"
                        title={t('products_best_charts_title')}
